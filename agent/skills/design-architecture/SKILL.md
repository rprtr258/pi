...
description: Define the structural layer of a product or site before visual design begins. Covers navigation, content hierarchy, page structure, URL patterns, and user flows. Use when planning site structure, navigation, user flows, organizing content, or mentions "IA" or "information architecture".
---
...
- "Plan the design architecture for this app before I start building"
...
4. Once you have a shared understanding, produce the design architecture document using the template below and save it as `DESIGN_ARCHITECTURE.md` in the same `.design/<feature-slug>/` subfolder as the design brief.

## Design Architecture Document Template

```markdown
# Design Architecture: [Product/Site Name]
...
Which sections of the site will accumulate content over time and how the design architecture accommodates that growth (pagination, filtering, search, archive patterns).
