...
### 6A/6B: Deploy or Export — read `references/deploy-export.md`

Full step-by-step instructions for deploying to a live URL (Vercel) and exporting
to PDF live in [references/deploy-export.md](references/deploy-export.md). Read that file
only when the user picks one of these options.
