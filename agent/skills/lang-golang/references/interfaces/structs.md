...
→ See [naming](../naming.md) for interface naming conventions (method + "-er" suffix, canonical names)
...
- → See [naming](../naming.md) for interface naming conventions (Reader, Closer, Stringer)
- → See [design-patterns](../../patterns/design-patterns.md) for functional options, constructors, and builder patterns
- → See [dependency-injection](../../patterns/references/clean-architecture.md) for DI patterns using interfaces
- → See [code-style](../code-style/code-style.md) for value vs pointer function parameters (distinct from receivers)
