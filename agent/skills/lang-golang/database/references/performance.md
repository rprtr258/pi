...
→ See [observability](../../observability/observability.md) for database metrics and query monitoring. → See [cli-promql](../../../cli-promql/SKILL.md) for querying pool metrics (`db_open_connections`, `db_in_use_connections`, `db_idle_connections`) via CLI.
