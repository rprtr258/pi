...
Upgrade to golangci-lint v2. **Migration**: Run `golangci-lint migrate` to convert v1 config to v2. See the [lint](../../lint/lint.md) for the recommended configuration.
